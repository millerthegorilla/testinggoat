...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_for_one_user(self):
        # Edith has heard about a cool new online to-do app. She is
        # checking out its homepage when...
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        list_page_edith = ListPage(self).add_list_item('Buy peacock feathers')
        ...
        list_page_francis = ListPage(self).add_list_item('Buy milk')
